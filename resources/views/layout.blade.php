...
<body>
  ...
  <div class="page-container">
    <div class="sidebar-menu"> 
      <div class="sidebar-header">
        <div class="logo">
          <a href="index.html"><img src="{{asset('/deshboard/img/290018488_1110770999821005_2691879510461168954_n.png')}}" alt="Admin Panel"></a>
        </div>
      </div>
            ...
            <ul class="notification-area">
              <div class="user-wrapper">
                <div class="user-details" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2"
                  ...
                  <img src="/deshboard/img/03.jpg" alt="User-Profile-Image">
                ...
                <ul class="show-user-details shadow collapse" id="multiCollapseExample2">
                  ...
                  <li>
                    <a href="{{ url('user/profile/edit') }}"><i class="bi bi-person-fill"></i>Profile </a>
                  </li>
                  <li>
                    <form method="POST" action="{{ route('logout') }}">
                      ...
                      <a href="{{ route('logout') }}"
                              onclick="event.preventDefault();
                                          this.closest('form').submit();"><i class="bi bi-box-arrow-right"></i>
                          {{ __('Log Out') }}
                    </a>
                  </form>
                  </li>
  ...
  <script src="{{ asset('/deshboard/js/jquery-2.2.4.min.js') }}" ></script>
  <script src="{{ asset('/deshboard/js/bootstrap.min.js') }}" ></script>
  <script src="{{ asset('/deshboard/js/app.js') }}"></script>
  <script>
