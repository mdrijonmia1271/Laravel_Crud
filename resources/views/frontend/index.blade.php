                        ...
                        @foreach ($active_categories as $active_category)
                            <div class="featured-wrap">
                                <div class="featured-img">
                                    <img src="{{ asset('uploads/category_photos') }}/{{ $active_category->category_photo }}"
                                        alt="not found">
                ...
                @foreach ($active_products as $active_product)
                    <li class="col-xl-3 col-lg-4 col-sm-6 col-12 moreload">
                        <div class="product-wrap">
                            <div class="product-img">
                                <span>Sale</span>
                                <img src="{{ asset('uploads/product_photos') }}/{{ $active_product->product_thambnail_photo }}"
                                    alt="">
                                <div class="product-icon flex-style">
                                    <ul>
                                        <li><a data-toggle="modal" data-target="#exampleModalCenter"
                            ...
                            <div class="product-content">
                                <h3><a
                                        href="{{ url('product/details') }}/{{ $active_product->slug }}">{{ $active_product->product_name }}</a>
                                </h3>
                                <p class="pull-left">${{ $active_product->product_price }}

                                </p>
                                <ul class="pull-right d-flex">
                                    @if (averge_stars($active_product->id) == 0)
                                        No reviw yet
                                    @endif
                                    @for ($i = 1; $i <= averge_stars($active_product->id); $i++)
                                        <li><i class="fa fa-star"></i></li>
                                    @endfor
                                </ul>
                            </div>
                ...
                <div class="col-md-10 offset-md-1 col-12">
                    <div class="testmonial-active owl-carousel">
                        <div class="test-items test-items2">
                            ...
                            <div class="test-img2">
                                <img src="{{ asset('frontend') }}/images/test/1.png" alt="">
                            </div>
                        </div>
                        <div class="test-items test-items2">
                            <div class="test-content">
