...
//change user password of show confirm password------------
...
//Change user photo of show choose file
function showPhoto(input) {
  if (input.files && input.files[0]) {
    var reader = new FileReader();
    reader.onload = function (e) {
      $('#instant_photo_viewer').attr('src', e.target.result).width(150).height(150);
    };
    $('#instant_photo_viewer').removeClass('hidden');
